...
namespace dBParser
{
    public class MySQLParser : IDBParser
    {
        ...
        {
            ParameterList.Add(new MySqlParameter(name, value ?? string.Empty));
        ...
        public Guid AddNewReturnGuid(string TableName, string OutputQuery)
        {
            ...
            {
                connection.Open();
                using (MySqlDataAdapter sqlData = new MySqlDataAdapter(query, connection))
                {
                    ...
                    ParameterList = new List<MySqlParameter>();
                }
                connection.Close();
            }
            return output;
        ...
        public long AddNewReturnLong(string TableName, string OutputQuery = "")
        {
            ...
            {
                connection.Open();
                using (MySqlDataAdapter sqlData = new MySqlDataAdapter(str.ToString(), connection))
                {
                    sqlData.SelectCommand.Parameters.AddRange(ParameterList.ToArray());
