...
namespace dBParser
{
    public class OracleParser : IDBParser
    {
        ...
        {
            ParameterList.Add(new OracleParameter(name, value ?? string.Empty));
        ...
        public Guid AddNewReturnGuid(string TableName, string OutputQuery)
        {
            ...
            {
                connection.Open();
                using (OracleDataAdapter sqlData = new OracleDataAdapter(query, connection))
                {
        ...
        public long AddNewReturnLong(string TableName, string OutputQuery = "")
        {
            ...
            {
                connection.Open();
                using (OracleDataAdapter sqlData = new OracleDataAdapter(str.ToString(), connection))
                {
                    sqlData.SelectCommand.Parameters.AddRange(ParameterList.ToArray());
        ...
        public void Create(string TableName)
        {
            ...
            {
                connection.Open();
                using (OracleCommand sqlCom = new OracleCommand(query, connection))
                {
